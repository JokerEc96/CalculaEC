        ...
        <section className="py-10 sm:py-14">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-2">
            ...
            <section className="rounded-2xl border border-[var(--border)] bg-white p-5 lg:col-span-2">
              ...
              <p className="mt-1 text-sm leading-6 text-[var(--muted)]">Tu sueldo no permite saber por sí solo cuánto te corresponde de utilidades. Para un trabajador, lo importante es entender que existen dos partes: <strong>Base (10%)</strong>, por el tiempo trabajado, y <strong>Cargas (5%)</strong>, por las cargas familiares.</p>
              ...
              <div className="mt-5 rounded-xl border border-[var(--border)] bg-[var(--background)] p-4">
                ...
                <p className="mt-1 text-xs leading-5 text-[var(--muted)]">Estos datos te ayudan a saber tu participación, pero no permiten conocer el valor exacto en dólares sin el reparto de la empresa.</p>
